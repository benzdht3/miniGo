...
class ParserSuite(unittest.TestCase):
    ...
    def test_025(self):
        ...
        ""","Error on line 2 col 29: true", 325))
...
""","Error on line 2 col 23: )", 371))

    def test_074(self):
        """Declared"""
        self.assertTrue(TestParser.checkParser("""    
            func Add(a int, ) {}
""","Error on line 2 col 29: )", 374))
        
    def test_075(self):
        """Declared"""
        self.assertTrue(TestParser.checkParser("""    
            type Calculator struct {value int}
""","Error on line 2 col 46: }", 375))
        
    def test_081(self):
        """Declared"""
        self.assertTrue(TestParser.checkParser("""    
            type Calculator interface {Reset()}
""","Error on line 2 col 47: }", 381))
...
""","Error on line 7 col 87: var", 395))
...
""","Error on line 4 col 17: else", 460))
...
""","successful", 468))
    ...
    def test_181(self):
        self.assertTrue(TestParser.checkParser("""
                                            var a;
                                        ""","Error on line 2 col 50: ;", 481))
        
    def test_182(self):
        self.assertTrue(TestParser.checkParser("""
                                            var a = {1, 2};
                                        ""","Error on line 2 col 53: {", 482))
